...
import FoodRequestAPI.database.utility.DatabaseExceptionType;
import FoodRequestAPI.entity.MapEntity;
import javafx.scene.control.Alert;
import org.springframework.util.StringUtils;
import FoodRequestAPI.utility.node.NodeBuilding;
            ...
            while (reader.readRecord()) {
                ...
                try {
                    ...
                    if (e.getType() == DatabaseExceptionType.ID_ALREADY_EXISTS || e.getType() == DatabaseExceptionType.DUPLICATE_ENTRY) {
                        ...
                        alert.setHeaderText("Error occurred while adding node to FoodRequestAPI.database from CSV.");
                        alert.setContentText(e.toString());
                        alert.showAndWait();
                    }
                }
            ...
            while (reader.readRecord()) {
                ...
                try {
                    ...
                    if (e.getType() == DatabaseExceptionType.ID_ALREADY_EXISTS || e.getType() == DatabaseExceptionType.DUPLICATE_ENTRY) {
                        ...
                        alert.setHeaderText("Error occurred while adding edge to FoodRequestAPI.database from CSV.");
                        alert.setContentText(e.toString());
                        alert.showAndWait();
                    }
                }
