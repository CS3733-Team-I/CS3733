...
import FoodRequestAPI.utility.request.*;
...
public class RequestEntity {
    ...
    /**
     * reads all requests from the FoodRequestAPI.database
     */
    ...
    /**
     * Generic request for deleting a request from the FoodRequestAPI.database and hashmaps
     * @param requestID
     */
...
//        }
    ...
    /**
     * Updates a request that is already in the FoodRequestAPI.database with the given requestID
     * @param requestID
     * @param nodeID
     * @param assignerID
     * @param note
    ...
    /**
     * Adds an interpreter request to the FoodRequestAPI.database
     * @param nodeID
     * @param assignerID
     * @param note
     * @param lang
     * @return adds an interpreter request to the FoodRequestAPI.database and returns that request
     */
    ...
    /**
     * gets an interpreter request from the FoodRequestAPI.database
     * @param requestID
     * @return gets an interpreter request from the FoodRequestAPI.database that matches the given requestID
    ...
    public InterpreterRequest getInterpreterRequest(String requestID) throws NullPointerException{
        ...
        if(interpreterRequests.containsKey(requestID)) {
            ...
            if(interpreterRequests.containsKey(requestID)){
                ...
                throw new NullPointerException("Unable to find InterpreterRequest in FoodRequestAPI.database");
            }
        }
    }
    ...
    /**
     * gets a security request from the FoodRequestAPI.database
     * @param requestID
     * @return gets a security request form the FoodRequestAPI.database that matches the requestID
     * @throws NullPointerException
     */
    public SecurityRequest getSecurityRequest(String requestID) throws NullPointerException{
        ...
        if(securityRequests.containsKey(requestID)) {
            ...
            if(securityRequests.containsKey(requestID)){
                ...
                throw new NullPointerException("Unable to find SecurityRequest in FoodRequestAPI.database");
            }
        }
    }

    /**
     * updates a securityRequest that is currently in the FoodRequestAPI.database
     * @param requestID
     * @param nodeID
     * @param assignerID
     * @param note
    ...
    /**
     * Adds food request to the FoodRequestAPI.database and the hashmaps
     * @param nodeID
     * @param assignerID
     * @param note
     * @param destinationNodeID
     * @param deliveryDate
     * @return Adds food request to the FoodRequestAPI.database and the hashmaps
     */
    ...
    /**
     * gets a food request form the FoodRequestAPI.database
     * @param requestID
     * @return gets a food request from the FoodRequestAPI.database that matches the given requestID
     * @throws NullPointerException
     */
    public FoodRequest getFoodRequest(String requestID)throws NullPointerException{
        ...
        if (foodRequests.containsKey(requestID)){
            ...
            if(foodRequests.containsKey(requestID)){
                ...
                throw new NullPointerException("Unable to find Food Request in FoodRequestAPI.database");
            }
        }
    }

    /**
     * updates a foodRequest that is currently in the FoodRequestAPI.database
     * @param requestID
     * @param nodeID
     * @param assignerID
     * @param note
