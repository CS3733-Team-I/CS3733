...
public class MapEntity implements IMapEntity {
    ...
    /**
     * Clears the cached nodes/edges and then adds all the existing nodes and edges from the  FoodRequestAPI.database.
     */
    public void readAllFromDatabase() throws DatabaseException {
        // TODO do this somewhere else, and be more smart about our FoodRequestAPI.database access
    ...
    public Node getNode(String s) throws NotFoundException{
        ...
        //If the node isn't in the map, check the FoodRequestAPI.database to see if it even exists.
        try {
    ...
    public Edge getEdge(String s) throws DatabaseException {
        ...
        // If edge doesn't exist, attempt to load it from the FoodRequestAPI.database
        if (edge == null) {
