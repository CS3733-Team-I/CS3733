package FoodRequestAPI.database.connection;

import FoodRequestAPI.database.objects.*;
import FoodRequestAPI.database.template.SQLStrings;
...
public class Connector {
    ...
    /**TODO: make request FoodRequestAPI.database access as generic as possible to reduce workload**/
