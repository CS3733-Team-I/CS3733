...
public class EmailSender {
     ...
     *
     * @param email the FoodRequestAPI.email to be parsed
     * @return MimeMessage to be used to send FoodRequestAPI.email
     * @throws IOException
     ...
     * @return the MimeMessage to be used to send FoodRequestAPI.email
    ...
    /**
     * Create a message from an FoodRequestAPI.email
     *
     * @param emailContent Email to bet to raw of message
     * @return a message containing a base64url encoded FoodRequestAPI.email
     * @throws MessagingException
     * @throws IOException
     */
    ...
    /**
     * Send an FoodRequestAPI.email from the user's mailbox to its recipient
     *
     * @param service Authorized Gmail API instance
     * @param userId User's FoodRequestAPI.email address.  The special value "me"
