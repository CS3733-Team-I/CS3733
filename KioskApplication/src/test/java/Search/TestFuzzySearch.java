...
public class TestFuzzySearch {
    ...
    */
    ...
    public void setup() throws DatabaseException {
        ...
        map.addNode(new Node("NODE13", 30, 30, NodeFloor.THIRD, NodeBuilding.FRANCIS45, NodeType.DEPT, "Gynecology Department", "NODE13_SN", "I"));
        ...
        map.addNode(new Node("NODE20", 30, 60, NodeFloor.THIRD, NodeBuilding.FRANCIS45, NodeType.DEPT, "General Suite", "NODE20_SN", "I"));
        map.addNode(new Node("NODE21", 40, 60, NodeFloor.THIRD, NodeBuilding.FRANCIS45, NodeType.HALL, "NODE21_LN A", "NODE21_SN", "I"));
        map.addNode(new Node("NODE22", 30, 70, NodeFloor.THIRD, NodeBuilding.FRANCIS45, NodeType.LABS, "Reproductive Endocrine Labs", "NODE22_SN", "I"));
        map.addNode(new Node("NODE23", 40, 70, NodeFloor.THIRD, NodeBuilding.FRANCIS45, NodeType.DEPT, "Orthopedics and Rhemutalogy", "NODE23_SN", "I"));
        //Nodes for F2
        map.addNode(new Node("NODE24", 10, 10, NodeFloor.SECOND, NodeBuilding.FRANCIS45, NodeType.ELEV, "Elevator A", "Elev A", "I"));
        map.addNode(new Node("NODE25", 20, 10, NodeFloor.SECOND, NodeBuilding.FRANCIS45, NodeType.DEPT, "General Surgical Specialties Suite A", "NODE25_SN", "I"));
        map.addNode(new Node("NODE26", 30, 10, NodeFloor.SECOND, NodeBuilding.FRANCIS45, NodeType.DEPT, "General Surgical Specialties Suite B", "NODE26_SN", "I"));
        ...
        map.addNode(new Node("NODE29", 70, 10, NodeFloor.SECOND, NodeBuilding.FRANCIS45, NodeType.DEPT, "Ambulatory X-Ray Floor 1", "NODE29_SN", "I"));
        ...
        map.addNode(new Node("NODE34", 60, 20, NodeFloor.SECOND, NodeBuilding.FRANCIS45, NodeType.DEPT, "Ambulance Parking Exit Floor 1", "NODE34_SN", "I"));
        ...
        map.addNode(new Node("NODE38", 50, 30, NodeFloor.SECOND, NodeBuilding.FRANCIS45, NodeType.LABS, "Outpatient Speciman Collection Level 2", "NODE38_SN", "I"));
        ...
        map.addNode(new Node("NODE52", 70, 10, NodeFloor.FIRST, NodeBuilding.FRANCIS45, NodeType.RETL, "Au Xin Bun", "NODE52_SN", "I"));
        ...
        map.addNode(new Node("NODE61", 50, 30, NodeFloor.FIRST, NodeBuilding.FRANCIS45, NodeType.DEPT, "Obstetrics Department", "NODE61_SN", "I"));
